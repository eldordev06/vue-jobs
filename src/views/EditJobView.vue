...
const handleSubmit = async () => {
    ...
    try {
        const res = await axios.patch(`/api/jobs/${jobId}`, updatedJob);
        router.push(`/jobs/${res.data.id}`);
        toast.success("Job Was Updated Successfully");
    } catch (error) {
        console.error("Error editing job", error);
        toast.error("Error Was Not Updated");
    }
};
...
onMounted(async () => {
    try {
        ...
        toast.error("Error Getting Job Data")
    } finally {
        ...
        <div class="container m-auto max-w-2xl py-24">
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        <label for="type"
                               class="block text-gray-700 font-bold mb-2">Job Type</label>
                    ...
                    <div class="mb-4">
                        <label for="company"
                               class="block text-gray-700 font-bold mb-2">Company Name</label>
